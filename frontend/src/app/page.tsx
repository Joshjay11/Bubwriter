    ...
    <div className="max-w-3xl mx-auto">
      ...
      {step === 1 && (
        <div className="animate-in fade-in">
          ...
          <textarea
            ...
            placeholder="Paste at least 500 words of your writing here..."
            className="w-full h-48 bg-zinc-900 rounded-lg p-4 text-zinc-100 placeholder:text-zinc-600 resize-none focus:outline-none focus:ring-1 focus:ring-zinc-700 mb-2"
          />
          ...
          <button
            ...
            disabled={wordCount < 500 || analyzing}
          ...
          >
            {analyzing ? "Analyzing your writing..." : "Analyze My Writing"}
          </button>
        </div>
      )}

      {/* Step 2: Style Markers Review */}
      {step === 2 && styleMarkers && (
        <div className="animate-in fade-in">
          <h1 className="text-3xl font-bold mb-2">Your Style Snapshot</h1>
          <p className="text-zinc-400 mb-6">
            Here&apos;s what we found in your writing. Ready to go deeper?
          </p>

          <div className="grid gap-3 mb-8">
            <StyleCard label="Vocabulary" value={styleMarkers.vocabulary_tier} />
            <StyleCard label="Sentence Length" value={styleMarkers.avg_sentence_length} />
            <StyleCard label="Sentence Variety" value={styleMarkers.sentence_variety} />
            <StyleCard label="Pacing" value={styleMarkers.pacing_style} />
            <StyleCard label="Emotional Register" value={styleMarkers.emotional_register} />
            <StyleCard label="Sensory Preference" value={styleMarkers.sensory_preference} />
            ...
            <StyleCard label="Figurative Language" value={styleMarkers.figurative_language} />
            <StyleCard label="Structural Patterns" value={styleMarkers.structural_patterns} />
      ...
      {step === 3 && (
        <div className="animate-in fade-in">
          ...
          <p className="text-zinc-400 mb-6">
            Let&apos;s explore your writing instincts. Answer naturally — there
          ...
          {/* Interview complete → advance to Step 4 */}
          {interviewComplete ? (
            <button
              onClick={() => setStep(4)}
              className="w-full rounded-lg bg-zinc-100 px-6 py-3 text-zinc-900 font-medium hover:bg-zinc-200 transition-colors"
            ...
            <div>
              <textarea
                ...
                className="w-full h-24 bg-zinc-900 rounded-lg p-4 text-zinc-100 placeholder:text-zinc-600 resize-none focus:outline-none focus:ring-1 focus:ring-zinc-700 mb-3"
                disabled={streaming}
              />
