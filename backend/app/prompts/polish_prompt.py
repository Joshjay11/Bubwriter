...
CRITICAL: The prose was generated by a specific voice model chosen to match this writer's style. Preserve the existing voice, cadence, and word choices. Your job is to POLISH, not REWRITE. If a sentence sounds unusual but intentional, leave it. Only fix clear errors in flow, consistency, or remaining AI tells.
